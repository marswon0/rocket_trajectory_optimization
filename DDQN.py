...
def build_network(lr, n_actions, input_dims, fc1_dims, fc2_dims):
    model = Sequential()
...
class Agent(object):
    def __init__(self, alpha, gamma, n_actions, epsilon, batch_size,
        ...
        self.q_eval = build_network(alpha, n_actions, input_dims, 256, 256)
        self.q_target = build_network(alpha, n_actions, input_dims, 256, 256)
